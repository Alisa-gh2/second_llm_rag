...
def build_prompt(query: str, context_chunks: List[Dict]) -> str:
	...
	"Ты — ассистент, отвечающий на основе предоставленного контекста."
	"Контекст может содержать нужную информацию в разных фрагментах."
	"Твоя задача: найти в контексте ответ на вопрос."
	"Если точной фразы нет, но можно логически вывести ответ из контекста — сделай это и укажи, что это вывод (например: "Из контекста следует, что ...")."
	"Если информации действительно недостаточно, напиши: 'Информации в предоставленных документах не хватает"
	"Ответ должен быть кратким, по существу, на русском языке."
    )
    return f"{system_msg}\n\nКонтекст:\n{context}\n\nВопрос: {query}\nОтвет:"
